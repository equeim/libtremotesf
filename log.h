...
namespace libtremotesf {
    namespace impl {
        ...
        template<typename T>
        concept IsQStringView = std::same_as<std::remove_cv_t<std::remove_reference_t<T>>, QStringView>
#if QT_VERSION_MAJOR >= 6
                                || std::same_as<std::remove_cv_t<std::remove_reference_t<T>>, QUtf8StringView> ||
                                std::same_as<std::remove_cv_t<std::remove_reference_t<T>>, QAnyStringView>
#endif
            ;
